...
class PoseResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        #print( 'Dimension of Upsampling Level 1 SFA 3D Dataset is : ' + str( up_level1.size ))
        
        #print( 'Dimension of Output Sampling Level 3 SFA 3D Dataset is : ' + str( out_layer3.size ))
